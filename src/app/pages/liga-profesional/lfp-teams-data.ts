...
export const LPF2026_TEAMS: Array<{
  ...
  // ─── Zona A ───
  { name: 'Boca',                      zone: 'A', city: 'Buenos Aires',      attack: 78, defense: 76, stamina: 82 },
  { name: 'Vélez Sarsfield',           zone: 'A', city: 'Buenos Aires',      attack: 75, defense: 74, stamina: 81 },
  { name: 'Talleres de Córdoba',       zone: 'A', city: 'Córdoba',           attack: 74, defense: 72, stamina: 80 },
  ...
  { name: 'Unión de Santa Fe',         zone: 'A', city: 'Santa Fe',          attack: 68, defense: 64, stamina: 77 },
  ...
  { name: 'Racing Club',               zone: 'B', city: 'Avellaneda',        attack: 77, defense: 75, stamina: 82 },
...
export const LPF2026_SCHEDULE: Array<Array<[string, string]>> = [
  ...
  [
    ...
    ['Huracán', 'Banfield'], ['Platense', 'Unión de Santa Fe'], ['Estudiantes de Río Cuarto', 'CA Tigre'],
    ["Newell's Old Boys", 'Talleres de Córdoba'], ['River Plate', 'Barracas Central'], ['Lanús', 'San Lorenzo'],
  ...
  [
    ...
    ['Talleres de Córdoba', 'Vélez Sarsfield'], ['Independiente', "Newell's Old Boys"], ['Central Córdoba (SdE)', 'Atlético Tucumán'],
    ['Boca Juniors', 'Estudiantes (LP)'], ['CA Tigre', 'Belgrano'], ['Unión de Santa Fe', 'Lanús'],
  ],
  // Fecha 3
  [
    ['Gimnasia y Esgrima (M)', 'Unión de Santa Fe'], ['Estudiantes de Río Cuarto', 'Banfield'], ['Belgrano', 'Argentinos Juniors'],
    ...
    ['Lanús', 'Instituto'], ['Sarmiento de Junín', 'Independiente Rivadavia'], ['Platense', 'Talleres de Córdoba'],
    ['Vélez Sarsfield', 'Independiente'], ['Central Córdoba (SdE)', 'San Lorenzo'], ['Huracán', 'Atlético Tucumán'],
  ],
  // Fecha 4
  [
    ['Unión de Santa Fe', 'Central Córdoba (SdE)'], ['Rosario Central', 'Aldosivi'], ['Argentinos Juniors', 'Racing'],
    ...
    ['Deportivo Riestra', 'Estudiantes (LP)'], ['Talleres de Córdoba', 'Lanús'], ['Independiente Rivadavia', 'Estudiantes de Río Cuarto'],
  ],
  // Fecha 5
  [
    ['Aldosivi', 'CA Tigre'], ['River Plate', 'Argentinos Juniors'], ['Lanús', 'Independiente'],
    ['San Lorenzo', 'Unión de Santa Fe'], ['Vélez Sarsfield', 'Defensa y Justicia'], ['Racing', 'Banfield'],
    ['Gimnasia y Esgrima (M)', 'Talleres de Córdoba'], ['Sarmiento de Junín', 'Huracán'], ['Estudiantes de Río Cuarto', 'Atlético Tucumán'],
  ...
  [
    ...
    ['Atlético Tucumán', 'Instituto'], ['Gimnasia y Esgrima (LP)', 'Gimnasia y Esgrima (M)'], ['Talleres de Córdoba', 'Rosario Central'],
    ...
    ['River Plate', 'Vélez Sarsfield'], ['Aldosivi', 'Unión de Santa Fe'], ['Lanús', 'Argentinos Juniors'],
  ],
  // Fecha 7
  [
    ['Defensa y Justicia', 'Platense'], ['Instituto', 'San Lorenzo'], ['Atlético Tucumán', 'Belgrano'],
    ['Talleres de Córdoba', 'Central Córdoba (SdE)'], ['Independiente', 'Gimnasia y Esgrima (M)'], ['CA Tigre', 'Barracas Central'],
    ['Rosario Central', 'Gimnasia y Esgrima (LP)'], ['Deportivo Riestra', 'Vélez Sarsfield'], ['Estudiantes (LP)', "Newell's Old Boys"],
    ['Unión de Santa Fe', 'Sarmiento de Junín'], ['Independiente Rivadavia', 'Racing'], ['Huracán', 'Estudiantes de Río Cuarto'],
    ['Banfield', 'River Plate'], ['Boca Juniors', 'Lanús'], ['Argentinos Juniors', 'Aldosivi'],
  ],
  // Fecha 8
  [
    ['Gimnasia y Esgrima (M)', 'Boca Juniors'], ['Central Córdoba (SdE)', 'Independiente'], ['San Lorenzo', 'Talleres de Córdoba'],
    ['Rosario Central', "Newell's Old Boys"], ['Barracas Central', 'Argentinos Juniors'], ['Unión de Santa Fe', 'Instituto'],
  ...
  [
    ...
    ['Independiente', 'San Lorenzo'], ['Talleres de Córdoba', 'Unión de Santa Fe'], ['Estudiantes (LP)', 'Platense'],
  ...
  // Fecha 10
  [
    ['Vélez Sarsfield', 'CA Tigre'], ['Unión de Santa Fe', 'Independiente'], ['Platense', "Newell's Old Boys"],
    ...
    ['Gimnasia y Esgrima (M)', 'Deportivo Riestra'], ['Central Córdoba (SdE)', 'Defensa y Justicia'], ['Instituto', 'Talleres de Córdoba'],
  ...
  [
    ...
    ['Talleres de Córdoba', 'Belgrano'], ['Sarmiento de Junín', 'River Plate'], ['Boca Juniors', 'Unión de Santa Fe'],
  ...
  [
    ...
    ['Gimnasia y Esgrima (M)', "Newell's Old Boys"], ['Unión de Santa Fe', 'Defensa y Justicia'], ['Talleres de Córdoba', 'Independiente'],
  ...
  [
    ...
    ['Boca Juniors', 'Talleres de Córdoba'], ['Vélez Sarsfield', 'Gimnasia y Esgrima (M)'], ['Deportivo Riestra', 'Unión de Santa Fe'],
  ...
  [
    ...
    ['Unión de Santa Fe', 'Estudiantes (LP)'], ['Independiente', 'Boca Juniors'], ['Barracas Central', 'Estudiantes de Río Cuarto'],
    ...
    ['Talleres de Córdoba', 'Defensa y Justicia'], ['Banfield', 'Lanús'], ['Central Córdoba (SdE)', 'Vélez Sarsfield'],
  ],
  // Fecha 15
  [
    ["Newell's Old Boys", 'Unión de Santa Fe'], ['Estudiantes de Río Cuarto', 'Gimnasia y Esgrima (LP)'], ['Estudiantes (LP)', 'Instituto'],
    ['Defensa y Justicia', 'Independiente'], ['Atlético Tucumán', 'Argentinos Juniors'], ['Racing', 'Aldosivi'],
    ['Boca Juniors', 'River Plate'], ['Sarmiento de Junín', 'Rosario Central'], ['Deportivo Riestra', 'Talleres de Córdoba'],
  ...
  [
    ...
    ['Talleres de Córdoba', 'Estudiantes (LP)'], ['CA Tigre', 'Sarmiento de Junín'], ['Aldosivi', 'River Plate'],
    ['Gimnasia y Esgrima (M)', 'Independiente Rivadavia'], ['Instituto', "Newell's Old Boys"], ['Gimnasia y Esgrima (LP)', 'Belgrano'],
    ['Banfield', 'Atlético Tucumán'], ['Unión de Santa Fe', 'Vélez Sarsfield'], ['Argentinos Juniors', 'Huracán'],
  ],
];